...
make -j8
#make test
jsrun -n1 -c20 -g1 -a1 nsys profile -o rrtmgp++.nsys -f true make test
jsrun -n1 -c20 -g1 -a1 ncu --target-processes=all --set=full --force-overwrite -o rrtmgp++.ncu.full make test
